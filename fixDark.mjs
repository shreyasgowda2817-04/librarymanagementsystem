...
function processFile(filePath) {
  ...
  // 1. Clean up previous manual dark mode replacements to avoid duplicates
  ...
  const mappings = [
    ...
    { from: /\bbg-gray-50\/50\b/g, to: 'bg-gray-50/50 dark:bg-[#0f172a]/50' },
    { from: /\bbg-gray-50\/80\b/g, to: 'bg-gray-50/80 dark:bg-[#0f172a]/80' },
    { from: /\bbg-gray-50\/30\b/g, to: 'bg-gray-50/30 dark:bg-[#0f172a]/30' },
...
traverse(pagesDir);
traverse(compDir);
console.log('✅ Dark mode mapped professionally across all components.');
